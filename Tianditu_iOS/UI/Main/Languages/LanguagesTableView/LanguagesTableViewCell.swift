...
class LanguagesTableViewCell: UITableViewCell {
    ...
    private let leftViewWidth: CGFloat = 20
...
extension LanguagesTableViewCell {
    ...
    private func setupRightView() {
        ...
        NSLayoutConstraint.activate([
            rightImageView.leadingAnchor.constraint(equalTo: rightView.leadingAnchor),
            rightImageView.trailingAnchor.constraint(equalTo: rightView.trailingAnchor),
            rightImageView.topAnchor.constraint(equalTo: rightView.topAnchor),
            rightImageView.bottomAnchor.constraint(equalTo: rightView.bottomAnchor),
            ])
    }
...
extension LanguagesTableViewCell {
    func setRightImage(img: UIImage? = nil) {
        rightImageView.image = img
    }
    func set(vm: LanguagesTableViewCellVM) {
        title.text = vm.originLanguage
        detail.text = vm.currentLanguage
    }
}
